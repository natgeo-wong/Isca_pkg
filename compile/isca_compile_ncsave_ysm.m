function isca_compile_ncsave_ysm (data,par,root,lvl)
...
nccreate(fnc,'yr','Dimensions',{ncdim,'t',l});
nccreate(fnc,'ss','Dimensions',{ncdim,'s',4,'t',l});
nccreate(fnc,'mo','Dimensions',{ncdim,'m',12,'t',l});
